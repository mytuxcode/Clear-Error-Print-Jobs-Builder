...
This project provides a **PowerShell toolset** to automatically clear errored print jobs from Windows print servers.  
...
### 1️⃣ `Clear-ErrorPrintJobs-Builder.ps1`
...
### 2️⃣ `Clear-ErrorPrintJobs-Custom.ps1`
...
### 🕓 Scheduling the Script to Run Every 30 Minutes
...
3. **Set the Trigger (every 30 minutes)**
   ...
   - Under **Advanced settings:**
     - Check ✅ *Repeat task every:* → choose **30 minutes**
...
✅ The script will now run every **30 minutes**, 24/7, automatically clearing any errored print jobs.
...
🗑️  Cleared job ID 105 on printer 001-ADMIN-LJ
🗑️  Cleared job ID 108 on printer 001-LIB-PRN
⚠️  Could not cancel job ID 112 on printer 001-LAB-PRN: Access denied
```
